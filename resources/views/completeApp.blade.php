                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Complete Application</h1>
                            </div>
                            <form method="POST" action="{{ route('CompleteApplications') }}">
                                  {{ csrf_field() }}
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="text" name="matricno" id="matricno" class="form-control form-control" id="exampleFirstName"
                                            placeholder="Matric Number" required="true">
                                    </div>
                                     <button class="btn px-4" type="submit" style="background:#c0a062;color:#FFF">Complete Application Now </button>
                            ...
                            <hr>
                            <div class="text-center">
                                <a class="small" href="{{ route('trackApp') }}" style="color:#da251d">Click To Retrieve Application</a>                            </div>
                            <div class="text-center">
