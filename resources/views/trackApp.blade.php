                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Track Application</h1>
                            </div>
                            <form method="POST" action="{{ route('TrackApplication') }}">
                                  {{ csrf_field() }}
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="text" name="trackid" class="form-control form-control" id="exampleFirstName"
                                            placeholder="Matric Number" required="true">
                                    </div>
                                     <button class="btn px-4" type="submit" style="background:#c0a062;color:#FFF">Track Now </button>
